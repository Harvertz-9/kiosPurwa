...
<template>
  <div class="bg-surface text-on-surface min-h-screen pb-2xl">
    ...
    <section class="relative w-full h-[60vh] md:h-[80vh] bg-surface-container flex items-center justify-center overflow-hidden">
      ...
      <div class="relative z-10 flex flex-col items-center text-center px-margin-mobile md:px-gutter max-w-[800px] gap-md">
    ...
    <div class="px-margin-mobile md:px-gutter max-w-[1440px] mx-auto pt-xl md:pt-2xl flex flex-col gap-2xl md:gap-[120px]">
      ...
      <section class="flex flex-col gap-xl bg-surface-bright rounded-[40px] p-lg md:p-2xl">
        ...
        <!-- Bento Grid -->
        <div class="grid grid-cols-1 md:grid-cols-2 gap-md md:gap-lg md:h-[600px] mt-md">
          <!-- Left Large -->
          <div class="relative rounded-3xl overflow-hidden group h-[300px] md:h-full">
            ...
            <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex items-end p-xl">
          ...
          <div class="flex flex-col gap-md md:gap-lg h-full">
            <!-- Top Right -->
            <div class="relative rounded-3xl overflow-hidden group flex-1 h-[250px] md:h-auto">
            ...
            <!-- Bottom Right Row -->
            <div class="grid grid-cols-2 gap-md md:gap-lg flex-1 h-[200px] md:h-auto">
              <!-- Bottom Left -->
              <div class="relative rounded-3xl overflow-hidden group">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex items-end p-lg">
      ...
      <!-- Testimonial Quote -->
      <section class="bg-primary-container/20 border border-primary/10 rounded-[32px] p-xl md:py-2xl md:px-3xl text-center max-w-4xl mx-auto flex flex-col gap-lg w-full">
      ...
      <section class="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-xl items-center bg-surface-bright rounded-[40px] overflow-hidden border border-surface-container-highest">
        <div class="h-[300px] md:h-[500px] w-full">
          ...
          <div class="flex flex-col gap-lg mt-sm">
            <div class="flex items-start gap-md">
              ...
              <div class="flex flex-col gap-1">
                ...
                <div class="font-body-md text-on-surface-variant">Jl. Lurus, Wayan Suta, Sukawati - Gianyar - Bali</div>
              </div>
            </div>
            ...
            <div class="flex items-start gap-md">
              ...
              <div class="flex flex-col gap-1">
                ...
                <div class="font-body-md text-on-surface-variant">Setiap hari : 08:00 - 16:00 WITA</div>
              </div>
            </div>
          </div>
