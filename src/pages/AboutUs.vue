  ...
  <div class="bg-surface text-on-surface min-h-screen pb-2xl">
    ...
    <div class="px-margin-mobile md:px-gutter max-w-360 mx-auto pt-xl md:pt-2xl flex flex-col gap-2xl md:gap-30">
      ...
      <section class="flex flex-col gap-xl bg-surface-bright rounded-[40px] p-lg md:p-2xl">
        <div class="text-center flex flex-col gap-sm" data-aos="fade-up">
      ...
      <section class="bg-primary-container/20 border border-primary/10 rounded-4xl p-xl md:py-2xl md:px-3xl text-center max-w-4xl mx-auto flex flex-col gap-lg w-full mt-5" data-aos="fade-up">
      ...
      <section class="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-xl items-center bg-surface-bright rounded-md overflow-hidden border border-surface-container-highest" data-aos="fade-up">
